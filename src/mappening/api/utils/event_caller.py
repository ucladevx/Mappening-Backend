from mappening.utils.database import pages_saved_collection, pages_unwanted_collection, unknown_locations_collection, events_ml_collection
...
def refresh_page_database():
    ...
    for page_id, page_name in tqdm(raw_page_data.iteritems()):
        ...
        unwanted_page = pages_unwanted_collection.find_one({'id': page_id})
        if unwanted_page:
            continue
